...
def record(name):
    ...
    CHUNK = 1024
    RECORD_SECONDS = 3
    WAVE_OUTPUT_FILENAME = "F:/voicerecog/samples"+name+".wav"
...
with open('F:/voicerecog/s.txt') as f:
...
AUDIO_FILE = ( "F:/voicerecog"+student)
...
try:
    ...
    print("Could not request results from System; {0}".format(e))
...
try:
    ...
    print("Could not request results from the System; {0}".format(e))
