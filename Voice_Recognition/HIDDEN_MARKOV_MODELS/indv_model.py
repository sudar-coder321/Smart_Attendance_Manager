...
training_speaker_name='nishant'

file_path='F:/voicerecog/datasets/'+training_speaker_name+'/'
...
print(N)
print(Mixtures)
model = GMMHMM(n_components=N, n_mix=Mixtures, covariance_type='full', init_params="mcw",n_iter = 200)
#plot_model(model)
...
# print(lengths.shape[0])
model.fit(feature,lengths)

joblib.dump(model, "F:/voicerecog/models"+training_speaker_name+".pkl")
